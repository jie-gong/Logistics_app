...
import com.example.logistics.admin.UpXinXi;
 ...
 */
public class DD2_Adapter extends BaseAdapter {
    private ArrayList<DD_bean> beans;

    public DD2_Adapter(ArrayList<DD_bean> beans) {
        this.beans = beans;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.newsInflateItem.setOnClickListener(view1 -> {
            Intent intent = new Intent(viewGroup.getContext(), UpXinXi.class);
